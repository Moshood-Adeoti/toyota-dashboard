  ...
  return (
    <div>
      ...
      <div className="bg-blue-900 text-white p-6 rounded-2xl">
        ...
        <p className="text-sm mt-2 text-center">Manage and track all your orders</p>
      </div>

      
      <div className="grid grid-cols-4 gap-4 mt-6 text-white">
      ...
      {/* Orders Table */}
      <div className="bg-blue-900 rounded-2xl px-10 mt-6 py-6">
        ...
        <table className="bg-white w-full rounded-lg overflow-hidden">
          ...
          <tbody>
            {filtered.map((order) => (
              <tr key={order.id} className="border-t border-gray-100 hover:bg-gray-50 transition duration-200">
